...
const IssuerLogin = () => {
  ...
  const onSubmit = async (data: LoginForm) => {
    setIsLoading(true);
    const result = await login(data.email, data.password, "issuer");
    setIsLoading(false);
  ...
  return (
    <AuthLayout
      title="Issuer Login"
      subtitle="Issue and manage credentials for your organization"
    >
      ...
      <div className="mt-6 text-center text-sm text-muted-foreground">
        ...
        <Link to="/signup/issuer" className="text-primary hover:underline font-medium">
          Sign up
        </Link>
      </div>
